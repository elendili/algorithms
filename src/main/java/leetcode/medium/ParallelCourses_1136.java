...
public class ParallelCourses_1136 {
    ...
    private int dfs(int node, List<Integer>[] nexts, int[] dp) {
        if (dp[node] != 0) {
            return dp[node];
        } else {
            dp[node] = -1;
